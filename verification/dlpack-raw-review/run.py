...
commands = {
    ...
    'red': ['cargo', 'test', '-j2', '--manifest-path', 'crates/ferro-py/Cargo.toml', '--lib', 'dlpack::tests::gpu_export_borrows_and_import_htod', '--', '--nocapture'],
    'green': ['cargo', 'test', '-j2', '--manifest-path', 'crates/ferro-py/Cargo.toml', '--lib', 'dlpack::tests::gpu_export_borrows_and_import_htod', '--', '--nocapture'],
